...
public class EAttendance extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_eattendance);
...
*/
	...
	*/
	...
	catch (IOException ioe) 
    {
		ioe.printStackTrace();}
				...
				*/
				...
				Intent in=new Intent(EAttendance.this,Home.class);
				startActivity(in);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.eattendance, menu);
		return true;
	}
