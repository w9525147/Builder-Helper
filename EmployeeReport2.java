...
public class EmployeeReport2 extends Activity implements OnClickListener {
   ...
   int a3=0,b3=0,b4=0,c3=0;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_employee_report2);
...
SQLHelper = new SQLiteHelper(this);  
       ...
       ab.setText(dob1);
        String income1=SQLHelper.selectincome(dob1);
        //tv1.setText(income1); 
        
       /* tv3.setText(dob1);
        String income2=SQLHelper.selectincome(dob1);*/
       
        income1=SQLHelper.selectincome(dob1);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.employee_report3, menu);
		return true;
	}
