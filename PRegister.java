...
public class PRegister extends Activity implements OnClickListener{
...
*/
		...
		submit1.setOnClickListener(this);*/
		  ...
		  view.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					Intent i = new Intent(PRegister.this,
							Home.class);
					startActivity(i);
	    ...
	    private DatePickerDialog.OnDateSetListener mDateSetListener = new DatePickerDialog.OnDateSetListener() {
				...
				public void onClick(View v) {
					...
					case R.id.button1:
				        ...
				        if(j.equals(""))
						{
							Toast.makeText(this, "Enter expense details", 10).show();	
						}
						else if(m.equals(""))
						{
							Toast.makeText(this, "Enter expense amount", 10).show();	
						}
				        
						else if(n.equals(""))
						{
							Toast.makeText(this, "Enter quantity", 10).show();	
						}
						else
						{
				       ...
				       if(ss.equals("success"))
				       {
						...
						Toast.makeText(this, "Successfully Registerd", 10).show();	
						expense.setText(" ");
						amount.setText("");
				       }}
